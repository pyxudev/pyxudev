...
<br>
Hi, thank you for reaching out to my profile.<br>
Justin Xu, a full-stack engineer, leader of `SenjuMeetup!`.<br>

![](https://github-readme-stats.vercel.app/api/top-langs?username=pyxudev&show_icons=true&locale=en&layout=compact)<br>
![](https://skillicons.dev/icons?i=md,html,css,js,ts,go,rust,python)<br>
![](https://skillicons.dev/icons?i=php,perl,arduino,bash,aws,azure,vercel,heroku)<br>
![](https://skillicons.dev/icons?i=linux,vim,git,gitlab,mysql,docker,discord,vscode)<br>
...
<details>
  ...
  - [AI_Auto_SNS](https://ai-auto-sns.vercel.app/)<br>
    An SNS users can do nothing but watching AI posting regard to current trends.<br>
    URL: https://ai-auto-sns.vercel.app/
  ...
  - [Bilibili Comment Logger](https://github.com/pyxudev/bilibili_comment_scraper)<br>
    It's a selenium scraper to scrape comments from bilibili in a headless environment.<br>
    Since they shut bilibili API down and changing their encrypt policy frequently, this is no longer be used.
  ---
</details>
...
<details>
  ...
  - [Local_LLM_Coding_Prediction](https://github.com/pyxudev/nextjs-local-llm-coding-prediction)<br>
...
<details>
  ...
  - [Riot_Discord_KDA_Bot](https://github.com/pyxudev/riot_discord_bot)<br>
    A bot that helps players in my game community(Discord) to show weekly KDA.<br>
    Register page: https://riot-discord-bot.vercel.app/
  
  - [Discord_AI_TestBot](https://github.com/pyxudev/DiscordAITestBot)<br>
  ...
  - [NBA_Schedule](https://github.com/pyxudev/nba_min_schedule)<br>
...
<details>
  ...
  - [Sports_Basketball_Scriper](https://github.com/pyxudev/SportsBasketScriper)<br>
    A urllip-bs4 scraping script to get holding basketball games in Tokyo, Chiba, Saitama.<br>
...
<details>
  ...
  - [Ban_Accounts](https://github.com/pyxudev/ban_account)<br>
    A Python script to ban inactive accounts.
  
  - [Gaussian_Filter](https://github.com/pyxudev/gaussian_filter)<br>
    A Python code for gaussian filter.
  
  - [Python_Statics_Codes](https://github.com/pyxudev/statics)<br>
    Some Python code for statics
  
  - [Tokyo_Weather](https://github.com/pyxudev/TokyoWeather)<br>
...
<details>
  ...
  - [Debian-Development-Environment-Setup-Script](https://github.com/pyxudev/Debian-Development-Environment-Setup-Script)<br>
  ...
  - [Astro-Vue-Todo](https://github.com/pyxudev/Astro-Vue-Todo)
    A ToDo app as an Astron + Vue.js template.
